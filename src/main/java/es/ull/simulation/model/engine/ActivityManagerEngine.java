...
import es.ull.simulation.utils.PrioritizedMap;
...
public class ActivityManagerEngine extends AbstractEngineObject {
	...
	public static final class FlowExecutorQueue extends PrioritizedMap<TreeSet<ElementInstance>, ElementInstance>{		
		...
		public void add(ElementInstance ei) {
			// The arrival order and timestamp are only assigned if the single IFlow
    ...
    private final ActivityManagerEngine.FlowExecutorQueue currentQueue;
    ...
    */
    public ActivityManagerEngine(SimulationEngine simul, ActivityManager modelAM) {
        ...
        waitingQueue = new ActivityManagerEngine.FlowExecutorQueue();
        currentQueue = new ActivityManagerEngine.FlowExecutorQueue();
